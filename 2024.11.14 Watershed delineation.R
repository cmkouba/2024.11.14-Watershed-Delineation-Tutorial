...
# Before we get started let's make sure everyone is looking at this
# in RStudio as a "Project". (Project button in the upper right.)

# Once we are all looking at the "2024.11.14 WatershedDelineation Tutorial" 
# R Project,  we will be able to use something called "relative path names" 
# in which we can specify the location of a data file in our computer without
# typing out the pathname. 
# (e.g. "C:/Users/username/Documents/GitHub/Tutorials/2024.11.14 Watershed Delineation Tutorial")
# And it will run on multiple different computers without breaking.
